...
type
  ...
  public
    ...
    { Is called once every frame to render the frame.

      Parameters:
        ADeltaTimeSec: time since last Render call in seconds.
        ATotalTimeSec: time since the app started, in seconds

      Must be overridden. }
    procedure Render(const ADeltaTimeSec, ATotalTimeSec: Double); virtual; abstract;
